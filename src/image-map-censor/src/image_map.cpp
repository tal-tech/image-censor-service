...
// {
// public:
// 	Image_Map(std::string det_model,std::string image_path,std::string config_file_path);
// 	void test();
// private:
...
int main(int argc, char *argv[]) {
	...
	const std::string det_model = "/home/diaoaijie/workspace/image-service2/src/image-map-censor/src/ai_model/model/det_body_ssd_mobilenetv1_v2.0.1.uff";
	const std::string image_path = "/home/diaoaijie/workspace/image-service2/src/image-map-censor/src/ai_model/images/testing/JPEGImages/1.jpeg";
	const std::string config_file_path = "/home/diaoaijie/workspace/image-service2/src/image-map-censor/src/ai_model/model/config.ini";
