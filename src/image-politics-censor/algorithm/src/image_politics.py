...
# class Image_Politics:
#     def __init__(self,gallery_dir):
#         self.gallery_dir = gallery_dir
#         self.interface = Interface(self.gallery_dir)

#     def test(self,img_path1,img_path2):
#         img = cv2.imread(img_path1)
#         print(self.interface.query(img,0))
        
#         img = cv2.imread(img_path2)
#         print(self.interface.add_id(img, id_name='习大大', img_id=9999, lib_id=0))
#         print(self.interface.del_id(img_id=9999,lib_id=0))
